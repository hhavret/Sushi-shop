	 ...
	 ?>
	   ...
	   <div class="panier content-wrapper">   
	       ...
	       <td><a href="index.php?page=produit&id=<?=$produit['id']?>"><?=$produit['nom']?></a>   
	                      ...
	                      <td style="color: crimson"> <"class="quantité"><input type="number" name="quantité-<?=$produit['id']?>" value="<?=$produits_in_panier[$produit['id']]?>" min="1" max="<?=$produit['quantité']?>" placeholder="quantité" required></td>   
